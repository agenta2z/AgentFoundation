...
Mapping:
    ...
    - content     → content
    - entity_id   → namespace
    - knowledge_type, tags, entity_id, source → metadata dict
...
class RetrievalKnowledgePieceStore(KnowledgePieceStore):
    ...
    def _piece_to_doc(self, piece: KnowledgePiece) -> Document:
        ...
        knowledge_type, tags, entity_id, and source into metadata.
    ...
    def _doc_to_piece(self, doc: Document) -> KnowledgePiece:
        ...
        Extracts knowledge_type, tags, entity_id, and source from the
        document's metadata dict and reconstructs a KnowledgePiece.
