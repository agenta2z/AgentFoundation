    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          cursor: 'pointer',
          backgroundColor: theme?.custom?.surfaces?.sidebarBg || 'rgba(30,30,30,0.95)',
          borderBottom: isCollapsed ? 'none' : `1px solid ${theme?.custom?.surfaces?.overlayActive || 'rgba(255,255,255,0.08)'}`,
          '&:hover': { backgroundColor: theme?.custom?.surfaces?.scrim || 'rgba(255,255,255,0.04)' },
        }}
      >
          ...
          {section.prompt_file && (
            <Button
              ...
              sx={{
                ...
                '&:hover': {
                  color: 'primary.light',
                  backgroundColor: theme?.custom?.surfaces?.overlayActive || 'rgba(255,255,255,0.08)',
                },
              }}
            >
              View Prompt
