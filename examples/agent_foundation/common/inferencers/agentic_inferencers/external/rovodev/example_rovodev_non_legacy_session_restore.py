...
Usage:
    ...
    python example_rovodev_non_legacy_session_restore.py --target-path /path/to/repo
"""
...
def main():
    ...
    if args.target_path:
        ...
        target_path = tempfile.mkdtemp(prefix="rovodev_nonlegacy_session_")
        subprocess.run(
    ...
    try:
        ...
        # --- Session A ---
        inferencer_a = create_inferencer(target_path)
        ...
        # --- Session B ---
        inferencer_b = create_inferencer(target_path)
        ...
        inferencer_resume_a = create_inferencer(target_path)
        ...
        inferencer_resume_b = create_inferencer(target_path)
